...
# Custom CSS
st.markdown("""<style>
@import url('https://fonts.googleapis.com/css2?family=Fraunces:ital,wght@1,400;1,700&family=Karla:wght@400;500;700&display=swap');
...
.stTabs [aria-selected="true"] {
    ...
    border: 1px solid #5B8A72 !important;
}
.arch-container {
    background: #EFEAE3;
    border-radius: 16px;
